        ...
        <div class="col-lg-6 g-2">
            <div class="row justify-content-center align-items-center g-2  g-2 m-5">
                <div class="col-lg-6 g-2 text-center">
                    <button className='col-lg-6 btn btn-success' onClick={increase}>Increment</button>
                </div>
                <div class="col-lg-6 g-2 text-center">
                    <button className='col-lg-6 btn btn-success' onClick={decrease}>Decrement</button>
                </div>
            </div>
